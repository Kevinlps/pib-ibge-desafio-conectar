  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const urlPibTotal = "https://servicodados.ibge.gov.br/api/v3/agregados/5938/variaveis/37?localidades=N1[all]";
        const urlPibPerCapita = "https://servicodados.ibge.gov.br/api/v3/agregados/5938/variaveis/38?localidades=N1[all]";
        ...
        const dadosValidos = anos
          ...
          .filter(item => item.totalUSD > 0 && item.perCapitaUSD > 0);
        ...
        console.log("Dados processados com sucesso:", {
          ...
          exemploTotal2021: pibTotalFinal[anosFinais.indexOf('2021')]?.toLocaleString('en-US', { 
            style: 'currency', 
            currency: 'USD', 
            notation: 'compact' 
          }),
          exemploPerCapita2021: pibPerCapitaFinal[anosFinais.indexOf('2021')]?.toLocaleString('en-US', { 
            style: 'currency', 
            currency: 'USD' 
          }),
